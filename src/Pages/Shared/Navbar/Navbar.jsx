...
const Navbar = () => {
    ...
    const alllinks = <>
        ...
        <li className='text-base-content text-[16px] font-medium mb-1'><NavLink to={'/about'}>About Us</NavLink></li>
            ...
            <div className="navbar bg-white shadow-sm rounded-2xl py-4 md:px-4">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul
                            tabIndex="-1"
                            className="menu menu-sm dropdown-content bg-base-200 rounded-box z-1 mt-4 w-52 p-3 shadow-sm hamburger">
                            {alllinks}
                        </ul>
                    </div>
