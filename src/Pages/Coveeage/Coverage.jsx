...
const Coverage = () => {
    ...
    return (
        <div className='max-w-11/12 md:max-w-10/12 mx-auto my-8'>
            <div className='p-20 bg-white rounded-4xl'>
                {/* Title */}
                ...
                <form className=' relative ' onSubmit={handleSearch}>
                    <input type="text" name='address' className='w-md bg-[#cbd5e14d] text-lg  py-3 px-5 pl-10 rounded-l-4xl outline-none' placeholder='Search here' />
